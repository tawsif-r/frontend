...
import { Feature, Column } from '@/app/types/types';
import { addData, updateData, deleteData, fetchData} from '@/app/services/apiService';
import FeatureForm from '@/app/components/forms/FeatureForm';
import FeatureTable from '@/app/components/tables/FeatureTable';

const scrapFeaturesTable: React.FC = () => {
...
export default scrapFeaturesTable;